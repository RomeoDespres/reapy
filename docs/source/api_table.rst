...
.. csv-table::
	...
	"`TakeFX_CopyToTake <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_CopyToTake>`_","`FX.copy_to_take <reapy.core.html#reapy.core.fx.FX.copy_to_take>`_; `FX.move_to_take <reapy.core.html#reapy.core.fx.FX.move_to_take>`_"
	"`TakeFX_CopyToTrack <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_CopyToTrack>`_","`FX.copy_to_track <reapy.core.html#reapy.core.fx.FX.copy_to_track>`_; `FX.move_to_track <reapy.core.html#reapy.core.fx.FX.move_to_track>`_"
	"`TakeFX_Delete <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_Delete>`_","`FX.delete <reapy.core.html#reapy.core.fx.FX.delete>`_"
	...
	"`TakeFX_GetCount <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetCount>`_","`Track.n_fx <reapy.core.track.html#reapy.core.track.track.Track.n_fx>`_"
	"`TakeFX_GetEnabled <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetEnabled>`_","`FX.is_enabled <reapy.core.html#reapy.core.fx.FX.is_enabled>`_"
	...
	"`TakeFX_GetFXName <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetFXName>`_","`FX.name <reapy.core.html#reapy.core.fx.FX.name>`_"
	...
	"`TakeFX_GetNumParams <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetNumParams>`_","`FX.n_params <reapy.core.html#reapy.core.fx.FX.n_params>`_"
	"`TakeFX_GetOffline <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetOffline>`_","`FX.is_online <reapy.core.html#reapy.core.fx.FX.is_online>`_"
	"`TakeFX_GetOpen <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetOpen>`_","`FX.is_ui_open <reapy.core.html#reapy.core.fx.FX.is_ui_open>`_"
	"`TakeFX_GetParam <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetParam>`_","`FX.params <reapy.core.html#reapy.core.fx.FX.params>`_"
	...
	"`TakeFX_GetParamName <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetParamName>`_","`FXParam.name <reapy.core.html#reapy.core.fx.FXParam.name>`_"
	...
	"`TakeFX_GetPreset <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetPreset>`_","`FX.preset <reapy.core.html#reapy.core.fx.FX.preset>`_"
	"`TakeFX_GetPresetIndex <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetPresetIndex>`_","`FX.preset_index <reapy.core.html#reapy.core.fx.FX.preset_index>`_"
	"`TakeFX_GetUserPresetFilename <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_GetUserPresetFilename>`_","`FX.preset_file <reapy.core.html#reapy.core.fx.FX.preset_file>`_"
	"`TakeFX_NavigatePresets <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_NavigatePresets>`_","`FX.use_next_preset <reapy.core.html#reapy.core.fx.FX.use_next_preset>`_; `FX.use_previous_preset <reapy.core.html#reapy.core.fx.FX.use_previous_preset>`_"
	"`TakeFX_SetEnabled <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_SetEnabled>`_","`FX.enable <reapy.core.html#reapy.core.fx.FX.enable>`_; `FX.disable <reapy.core.html#reapy.core.fx.FX.disable>`_"
	"`TakeFX_SetNamedConfigParm <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_SetNamedConfigParm>`_","TODO"
	"`TakeFX_SetOffline <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_SetOffline>`_","`FX.make_online <reapy.core.html#reapy.core.fx.FX.make_online>`_; `FX.make_offline <reapy.core.html#reapy.core.fx.FX.make_offline>`_"
	"`TakeFX_SetOpen <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_SetOpen>`_","`FX.open_ui <reapy.core.html#reapy.core.fx.FX.open_ui>`_; `FX.close_ui <reapy.core.html#reapy.core.fx.FX.close_ui>`_"
	"`TakeFX_SetParam <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_SetParam>`_","`FX.params <reapy.core.html#reapy.core.fx.FX.params>`_"
	...
	"`TakeFX_SetPreset <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_SetPreset>`_","`FX.preset <reapy.core.html#reapy.core.fx.FX.preset>`_"
	"`TakeFX_SetPresetByIndex <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TakeFX_SetPresetByIndex>`_","`FX.preset <reapy.core.html#reapy.core.fx.FX.preset>`_"
	...
	"`TrackFX_CopyToTake <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_CopyToTake>`_","`FX.copy_to_take <reapy.core.html#reapy.core.fx.FX.copy_to_take>`_; `FX.move_to_take <reapy.core.html#reapy.core.fx.FX.move_to_take>`_"
	"`TrackFX_CopyToTrack <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_CopyToTrack>`_","`FX.copy_to_track <reapy.core.html#reapy.core.fx.FX.copy_to_track>`_; `FX.move_to_track <reapy.core.html#reapy.core.fx.FX.move_to_track>`_"
	"`TrackFX_Delete <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_Delete>`_","`FX.delete <reapy.core.html#reapy.core.fx.FX.delete>`_"
	...
	"`TrackFX_GetEnabled <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetEnabled>`_","`FX.is_enabled <reapy.core.html#reapy.core.fx.FX.is_enabled>`_"
	...
	"`TrackFX_GetFXName <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetFXName>`_","`FX.name <reapy.core.html#reapy.core.fx.FX.name>`_"
	...
	"`TrackFX_GetNumParams <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetNumParams>`_","`FX.n_params <reapy.core.html#reapy.core.fx.FX.n_params>`_"
	"`TrackFX_GetOffline <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetOffline>`_","`FX.is_online <reapy.core.html#reapy.core.fx.FX.is_online>`_"
	"`TrackFX_GetOpen <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetOpen>`_","`FX.is_ui_open <reapy.core.html#reapy.core.fx.FX.is_ui_open>`_"
	"`TrackFX_GetParam <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetParam>`_","`FX.params <reapy.core.html#reapy.core.fx.FX.params>`_"
	...
	"`TrackFX_GetParamName <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetParamName>`_","`FXParam.name <reapy.core.html#reapy.core.fx.FXParam.name>`_"
	...
	"`TrackFX_GetPreset <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetPreset>`_","`FX.preset <reapy.core.html#reapy.core.fx.FX.preset>`_"
	"`TrackFX_GetPresetIndex <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetPresetIndex>`_","`FX.preset_index <reapy.core.html#reapy.core.fx.FX.preset_index>`_"
	...
	"`TrackFX_GetUserPresetFilename <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_GetUserPresetFilename>`_","`FX.preset_file <reapy.core.html#reapy.core.fx.FX.preset_file>`_"
	"`TrackFX_NavigatePresets <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_NavigatePresets>`_","`FX.use_next_preset <reapy.core.html#reapy.core.fx.FX.use_next_preset>`_; `FX.use_previous_preset <reapy.core.html#reapy.core.fx.FX.use_previous_preset>`_"
	"`TrackFX_SetEnabled <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_SetEnabled>`_","`FX.enable <reapy.core.html#reapy.core.fx.FX.enable>`_; `FX.disable <reapy.core.html#reapy.core.fx.FX.disable>`_"
	...
	"`TrackFX_SetOffline <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_SetOffline>`_","`FX.make_online <reapy.core.html#reapy.core.fx.FX.make_online>`_; `FX.make_offline <reapy.core.html#reapy.core.fx.FX.make_offline>`_"
	"`TrackFX_SetOpen <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_SetOpen>`_","`FX.open_ui <reapy.core.html#reapy.core.fx.FX.open_ui>`_; `FX.close_ui <reapy.core.html#reapy.core.fx.FX.close_ui>`_"
	"`TrackFX_SetParam <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_SetParam>`_","`FX.params <reapy.core.html#reapy.core.fx.FX.params>`_"
	...
	"`TrackFX_SetPreset <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_SetPreset>`_","`FX.preset <reapy.core.html#reapy.core.fx.FX.preset>`_"
	"`TrackFX_SetPresetByIndex <https://www.reaper.fm/sdk/reascript/reascripthelp.html#TrackFX_SetPresetByIndex>`_","`FX.preset <reapy.core.html#reapy.core.fx.FX.preset>`_"
