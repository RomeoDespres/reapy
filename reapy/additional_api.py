...
#     t = (
#         rpr_packp('MediaItem_Take*', p0), c_byte(p1), rpr_packs(p2), c_int(p3)
#     )
#     r = f(t[0], t[1], t[2], t[3])
...
#     f = CFUNCTYPE(c_byte, c_uint64, c_byte, c_byte, c_double, c_char_p,
#                   c_int)(a)
#     t = (
#         rpr_packp('MediaItem_Take*', p0), c_byte(p1), c_byte(p2), c_double(p3),
#         rpr_packsc(p4), c_int(p5)
#     )
...
#     f = CFUNCTYPE(
#         c_byte, c_uint64, c_byte, c_byte, c_double, c_int, c_char_p, c_int
#     )(a)
#     t = (
#         rpr_packp('MediaItem_Take*', p0), c_byte(p1), c_byte(p2), c_double(p3),
#         c_int(p4), rpr_packsc(p5), c_int(p6)
#     )
...
#     a = _ft['MIDI_SetEvt']
#     f = CFUNCTYPE(
#         c_byte, c_uint64, c_int, c_void_p, c_void_p, c_void_p, c_char_p, c_int,
#         c_void_p
#     )(a)
#     t = (
#         rpr_packp('MediaItem_Take*', p0), c_int(p1), c_byte(p2), c_byte(p3),
#         c_double(p4), rpr_packsc(p5), c_int(p6), c_byte(p7)
#     )
#     r = f(
#         t[0], t[1], byref(t[2]), byref(t[3]), byref(t[4]), t[5], t[6],
#         byref(t[7])
#     )
#     return (
