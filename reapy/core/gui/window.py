...
class TopCanvas(EventClient):
    ...
    @property
    def _size(self) -> ty.Tuple[int, int]:
...
class TopLevel(EventClient):
    ...
    def __init__(
        ...
        self._init_canvas_size = canvas_size
        self.canvas = TopCanvas(toplevel=self, size=canvas_size)
    ...
    def _args(
        ...
        return (
            ...
            self._dockstate, self.autofocus, self._init_canvas_size
        )
