...
def get_header_contents() -> str:
    ...
    header = '/Source%20code/js_ReaScriptAPI_def.h'
...
class Parcer:
    ...
    def _parce_line(self, line: str) -> FuncdefT:
        ...
        # if name == 'JS_Composite':
        #     print(line)
        #     print(ret, types, names, doc, sep='\n')
